...
export interface BiographySliceDefaultPrimary {
	...
	/**
	 * Pfp field in *Biography → Default → Primary*
	 *
	 * - **Field Type**: Image
	 * - **Placeholder**: *None*
	 * - **API ID Path**: biography.default.primary.pfp
	 * - **Documentation**: https://prismic.io/docs/field#image
	 */
...
export interface ContentIndexSliceDefaultPrimary {
	...
	/**
	 * Expand field in *ContentIndex → Default → Primary*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: content_index.default.primary.expand
	 * - **Documentation**: https://prismic.io/docs/field#key-text
	 */
