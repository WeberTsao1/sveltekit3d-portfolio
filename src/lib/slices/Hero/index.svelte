	...
	<div class="mx-auto w-full max-w-7xl">
		<div class="grid min-h-[65vh] grid-cols-1 items-center md:grid-cols-2">
			...
			<div class="col-start-1 md:row-start-1 select-none">
				...
				<span 
					class="job-title block bg-gradient-to-tr from-orange-200 via-blue-400 to-orange-600 bg-clip-text text-transparent 
